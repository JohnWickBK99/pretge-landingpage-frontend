...
export default function Header({
  ...
  lang: Locale
  dictionary: {
    nav: { solution: string; testimonial: string; compare: string; faq: string }
  ...
  useEffect(() => {
    const sections = ["features-section", "testimonials-section", "pricing-section", "faq-section"]
  ...
  return (
    <header className="sticky top-0 z-50 w-full py-4 px-4 bg-gray-50/80 backdrop-blur-lg border-b border-gray-200/50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Image src="/images/pre-tge-logo.png" alt="Pre-TGE Logo" width={150} height={40} />
        ...
        <div className="flex items-center space-x-4">
          <Button className="bg-black hover:bg-gray-800 text-white">{dictionary.buttons.buy_coin}</Button>
